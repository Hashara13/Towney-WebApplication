            ...
            >
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <Link to={`/profile/${script._id}`} className="text-xl font-semibold text-gray-900 hover:text-purple-600 transition-colors">
                      {script.title}
                    </Link>
                    <p className="flex-start text-sm text-purple-600 font-medium">{script.script}</p>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center mb-2">
                  <p className="text-sm font-medium text-gray-600">
                    Budget: <span className="text-green-600">{script.budget}</span>
                  </p>
                  <p className="text-lg font-bold text-gray-900"><span className="text-sm font-normal text-gray-500">{script.status}</span></p>
                </div>
