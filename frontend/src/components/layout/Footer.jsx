        ...
        <div class="container px-6 py-12 mx-auto">
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div class="sm:col-span-2">
              <h1 class="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white ml-[-10px]">
            ...
            <div>
              ...
              <div class="flex flex-col items-start ml-20 mt-5 space-y-2">
                <a
                  href="#"
            ...
            <div>
              ...
              <div class="flex flex-col items-start mt-5 space-y-2 ml-20">
                <a
                  href="#"
                  class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500"
                >
                ...
                <a
                  href="#"
                  class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-purple-500"
                >
                  Nearest Service
                </a>
              </div>
